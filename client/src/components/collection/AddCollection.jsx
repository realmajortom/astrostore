...
import {HomeDispatch, Token, Length} from '../home/Home';
...
function AddCollection() {
    ...
    return (
        <div>
            ...
            <ChunkyButton onPress={() => setVis(!vis)} text={'New Collection'}
                          type={'secondary'}/>

            <Dialog open={vis} onClose={() => setVis(!vis)}
                    classes={{paper: 'modalBody modalSmall'}}
                    aria-labelledby="New Collection Form" elevation={24}
                ...
                <div className='fieldWrapper'>
                    <TextField label="Collection Title"
                               placeholder="Homosapien Recipes" value={title}
